...
function Home() {
  return (
    <div>
      ...
      <section className="bg-gradient-to-b from-light-surface-glass to-light-bg dark:from-dark-bg-50 dark:to-dark-bg py-16 sm:py-24 transition-colors duration-300">
